...
type RoomUnitChatComposer struct {
...
func (c *RoomUnitChatComposer) Compose(compose core.OutgoingPacket) core.OutgoingPacket {
...
func (*RoomUnitChatComposer) GetId() uint16 {
	return outgoing.RoomUnitChatComposer
}
